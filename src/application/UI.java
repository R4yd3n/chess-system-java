...
public class UI {
	...
	try { 
		  ...
		  return new ChessPosition(column,row);
		   ...
		   throw new InputMismatchException("Erro lendo posicao de xadrez! Valores validos de: a1 ate h8");
	   }
	}
 ...
 //Mostra o tabuleiro.
  ...
  public static void printMatch(ChessMatch chessMatch, List<ChessPiece> captured){
	  ...
	  if(!chessMatch.getCheckMate()) {  
		  ...
		  System.out.println("Vencedor: " + chessMatch.getCurrentPlayer() + ". Parabens!");
	  }
  }
